...
class FootballController extends Controller
{
    public function index()
    {
       ...
       ->first();
        ...
        $fullFeedItems = [
            [
                'title' => 'Le futsal ivoirien en pleine expansion',
                'image' => '',
                'alt' => 'Futsal'
            ],
            [
                'title' => 'Handball : championnat national, phase retour lancée',
                'image' => '',
                'alt' => 'Handball'
            ],
            [
                'title' => 'Volleyball : reprise du championnat ce week-end',
                'image' => '',
                'alt' => 'Volleyball'
            ],
            [
                'title' => 'Futsal : un nouveau championnat régional lancé',
                'image' => '',
                'alt' => 'Futsal'
            ],
            [
                'title' => 'Water-polo : une compétition inédite à Abidjan',
                'image' => '',
                'alt' => 'Water-polo'
            ]
        ];

        return view('pages.sports.football', compact(
            'mainArticle',
            'feedItems',
            'gridItems',
            'videos',
