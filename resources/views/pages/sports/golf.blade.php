...
<div class="wrap">
    ...
    <div class="au-grid">
        <div class="au-main">
            <div class="cov-wrap" style="aspect-ratio:4/3;">
                <span class="cov-tag">Golf</span>
                <img src="" alt="{{ $mainArticle['alt'] }}">
            </div>
            <div style="margin-top:20px;">
                <span class="fdl-cat">Golf</span>
        ...
        <div class="au-list" style="padding-left:36px;border-left:1px solid var(--ligne);">
            <div class="fdl-head">Fil d'actualité — Golf</div>
            <div class="fdl">
    ...
    <div style="padding:10px 0 44px;border-top:1px solid var(--ligne);">
        <div class="fdl-head">Vidéos — Golf</div>
        <div class="vgrid">
            @foreach($videos as $video)
            <a class="vcard" href="{{ route('videos') }}">
                <div class="vthumb">
                    <span class="vcattag">Golf</span>
    ...
    <div style="padding:10px 0 60px;border-top:1px solid var(--ligne);">
        <div class="fdl-head">Fil d'actualité complet — Golf</div>
        <div class="fdg-grid">
