...
<div class="wrap">
    ...
    <div class="au-grid">
        <div class="au-main">
            <div class="cov-wrap" style="aspect-ratio:4/3;">
                <span class="cov-tag">SPORTS DE PRECISION</span>
        ...
        <div class="au-list" style="padding-left:36px;border-left:1px solid var(--ligne);">
            <div class="fdl-head">Fil d'actualité — SPORTS DE PRECISION</div>
            <div class="fdl">
    ...
    <div style="padding:10px 0 60px;border-top:1px solid var(--ligne);">
        <div class="fdl-head">Fil d'actualité complet — SPORTS DE PRECISION</div>
        <div class="fdg-grid">
