...
<div class="wrap">
    ...
    <div class="au-grid">
        ...
        <div class="au-list" style="padding-left:36px;border-left:1px solid var(--ligne);">
            <div class="fdl-head">Fil d'actualité — RUGBY</div>
            <div class="fdl">
    ...
    <div style="padding:10px 0 60px;border-top:1px solid var(--ligne);">
        <div class="fdl-head">Fil d'actualité complet — RUGBY</div>
        <div class="fdg-grid">
