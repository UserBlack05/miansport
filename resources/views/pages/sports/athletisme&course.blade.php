...
<div class="wrap">
    ...
    <div class="au-grid">
        <div class="au-main">
            <div class="cov-wrap" style="aspect-ratio:4/3;">
                <span class="cov-tag">ATHLETISME, COURSE & MULTISPORT</span>
                <img src="{{ asset($mainArticle['image'] ?? '') }}" alt="">
            </div>
        ...
        <div class="au-list" style="padding-left:36px;border-left:1px solid var(--ligne);">
            <div class="fdl-head">Fil d'actualité — ATHLETISME, COURSE & MULTISPORT</div>
            <div class="fdl">
                ...
                <a class="fdl-item" href="{{route('articles.show',$item['slug'])}}">
                    ...
                    <span class="fdl-time">{{ $item['datedecreation'] }}</span>
                </a>
                @endforeach
    ...
    <div style="padding:10px 0 60px;border-top:1px solid var(--ligne);">
        <div class="fdl-head">Fil d'actualité complet — ATHLETISME, COURSE & MULTISPORT</div>
        <div class="fdg-grid">
